...
function EmptyStateCard({
	...
	return (
		<div className="bg-violet-bg rounded-2xl p-8 flex flex-col items-center text-center">
			<div className="w-20 h-20 rounded-full bg-white shadow-card flex items-center justify-center mb-4 transition-transform duration-200 hover:scale-105">
				{icon}
			</div>
...
export function EmptyStates() {
	return (
		<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
			<EmptyStateCard
				icon={<Swords className="w-10 h-10 text-grapefruit-300" />}
			...
			/>
			<EmptyStateCard
				icon={<Trophy className="w-10 h-10 text-grapefruit-300" />}
			...
			/>
			<EmptyStateCard
				icon={<Users className="w-10 h-10 text-grapefruit-300" />}
